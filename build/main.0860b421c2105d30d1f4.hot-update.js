...
function (_React$Component) {
  ...
  function SignIn() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "onFocus", function (e) {
      _this.setState({
        isFocused: true
      });
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "onBlur", function (e) {
      _this.setState({
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SignIn, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        ...
        className: "G-form-label  ".concat(isFocused ? "G-label-animated" : ""),
        ...
        className: "input-border ".concat(isFocused ? "input-border-animated" : ""),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 95
        }
...
//# sourceMappingURL=main.0860b421c2105d30d1f4.hot-update.js.map