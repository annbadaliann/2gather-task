...
function (_React$Component) {
  ...
  function Media() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "selectFileHandler", function (e) {
      ...
      //   });
      _this.setState({
        imagesToPreview: _this.state.imagesToPreview.push({
          url: URL.createObjectURL(e.target.files[0]),
          type: e.target.files[0].type
        })
      });

      console.log(_this.state.imagesToPreview[0]);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Media, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        ...
        className: "gallery",
        style: {
          backgroundImage: "url(".concat(this.state.imagesToPreview[0].url, ")")
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 117
...
//# sourceMappingURL=main.29098c6ef65f11a8aaff.hot-update.js.map