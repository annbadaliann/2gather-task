          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formData.append("file", _this.state.imagesToUpload[0]); // for (let i = 0; i < this.state.imagesToUpload.length; i++) {
                ...
                formData.append("lng", _this.state.lng); // console.log(this.state.categoryId, "categoryId");
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      var _this$state6 = this.state,
          ...
          checkMarkFour = _this$state6.checkMarkFour,
...
//# sourceMappingURL=main.2c1c2fb11b8406153e32.hot-update.js.map