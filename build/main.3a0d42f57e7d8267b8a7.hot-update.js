  ...
  function TopicSuggestion() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "moveNextPage", function (page) {
      var _this$state = _this.state,
          _this$state$checkMark = _this$state.checkMark,
      ...
      var _this$state2 = _this.state,
          ...
          title = _this$state2$topicCon.form,
          description = _this$state2$topicCon.description,
          amount = _this$state2$topicCon.amount; // const {
      //   locationAndCategory,
      //   topicContent,
      //   media,
      //   review
      ...
      console.log(submitted, location, _this.state.page); // if (location && page === 1) {
      //   this.setState({
      //     page: 2,
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      var _this$state3 = this.state,
          _this$state3$checkMar = _this$state3.checkMark,
          locationAndCategory = _this$state3$checkMar.locationAndCategory,
          topicContent = _this$state3$checkMar.topicContent,
          media = _this$state3$checkMar.media,
          review = _this$state3$checkMar.review,
...
function (_React$Component) {
  ...
  function Media() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "uploadFileHandler", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.post("https://2.evollai.com/api/topic", fd).then(function (res) {
        console.log(res);
      });
    });
...
//# sourceMappingURL=main.3a0d42f57e7d8267b8a7.hot-update.js.map