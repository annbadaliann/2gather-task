  ...
  function TopicSuggestion() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "moveNextPage", function (page) {
      ...
      var _this$state = _this.state,
          _this$state$locationA = _this$state.locationAndCategory.form,
          category = _this$state$locationA.category,
          location = _this$state$locationA.location,
          _this$state$topicCont = _this$state.topicContent.form,
          title = _this$state$topicCont.title,
          description = _this$state$topicCont.description,
          amount = _this$state$topicCont.amount; // location and category

      if (submitted && location || category) {
        _this.setState({
          page: 2,
          checkMarkOne: true
        });
...
//# sourceMappingURL=main.63460b54d27385d482e1.hot-update.js.map