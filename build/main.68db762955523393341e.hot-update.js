  ...
  function TopicSuggestion() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
        var _this$state3, locationAndCategory, topicContent, media, token, formData, _i, res, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(_this.state.imagesToUpload.length);
                console.log(_this.state.imagesToUpload[i]);

                for (_i = 0; _i < _this.state.imagesToUpload.length; _i++) {
                  formData.append("file", _this.state.imagesToUpload[_i]);
...
//# sourceMappingURL=main.68db762955523393341e.hot-update.js.map