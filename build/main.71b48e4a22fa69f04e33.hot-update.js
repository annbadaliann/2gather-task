...
function (_React$Component) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                topicContent = _this.state.topicContent; //qich mnac
                ...
                formData.append("categoryId", _this.state.categoryId.id);
                formData.append("lat", _this.state.lat);
                formData.append("lng", _this.state.lng); //formData.append(`file`, this.state.imagesToUpload[0]);

                for (i = 0; i < _this.state.imagesToUpload.length; i++) {
                  formData.append("file[]", _this.state.imagesToUpload[i]); // vsyo      uxxaki ste mtacum em mi faylov kashxati , petqa mtacel erku faylov klni te che , hima mi faylov testenq , ete exav , kmna multiple faylerov mtacel
                } //stex foreach kar chmorenas
                //console.log(this.state.imagesToUpload[0]);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function componentDidMount() {
      this.getCategories();
    } //ura oncategory change fukian? yerevi jnjvela dra hamar chi linum
...
//# sourceMappingURL=main.71b48e4a22fa69f04e33.hot-update.js.map