  ...
  function TopicSuggestion() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
        var _this$state4, locationAndCategory, topicContent, media, token, formData, fileType, fileReader, res, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                fileType = _this.state.imagesToUpload[0];
                fileReader = new FileReader();

                fileReader.onloadend = function (e) {
                  var arrayBuffer = e.target.result;
                  Object(blob_util__WEBPACK_IMPORTED_MODULE_17__["arrayBufferToBlob"])(arrayBuffer, fileType.type).then(function (blob) {
                    console.log(blob, "=======================");
                  })["catch"](function (err) {
                    console.log(err, "+++++++++++++++++++++++++++++");
                  });
...
//# sourceMappingURL=main.785c06c3b368cda47f91.hot-update.js.map