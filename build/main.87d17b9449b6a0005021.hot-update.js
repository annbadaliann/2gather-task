...
function (_React$Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Media, [{
    ...
    value: function render() {
      ...
      }))), this.state.imagesToPreview.map(function (item) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
          className: "gallery",
          style: {
            backgroundImage: "url(".concat(_this2.state.imagesToPreview[0] ? _this2.state.imagesToPreview[0].url : null, ")")
          },
          onClick: _this2.openSlider,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 126
          }
...
//# sourceMappingURL=main.87d17b9449b6a0005021.hot-update.js.map