  ...
  function TopicSuggestion() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "moveToReview", function () {
      var _this$state3 = _this.state,
          ...
          imagesToPreview = _this$state3.media.imagesToPreview;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "sendData", function (fromPreview, fromUpload) {
      var _this$state$media = _this.state.media,
          imagesToPreview = _this$state$media.imagesToPreview,
          imagesToUpload = _this$state$media.imagesToUpload;

      _this.setState({
        imagesToPreview: fromPreview,
        imagesToUpload: fromUpload
      });
    });
...
//# sourceMappingURL=main.8c68015753a64589602b.hot-update.js.map