...
function (_React$Component) {
  ...
  function TopicSuggestion() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "state", {
      ...
      media: {
        form: {
          file: "blob:http://localhost:3000/c581c14d-e300-4f1f-acdf-3c1383f41290"
        }
      },
      review: {},
      checkMarkOne: false,
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "moveNextPage", function (pageNum) {
      ...
      if (page === 1) {
        ...
        if (submittedOne && location && categoryId) {
          _this.setState({
            page: 2,
            checkMarkOne: true
          });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formData.append("file", media.form.file);
                ...
                formData.append("categoryId", _this.state.categoryId); // for (let i = 0; i < dataCollected.filesToUpload.length; i++) {
                ...
                console.log(_this.state.categoryId, "categoryId");
...
//# sourceMappingURL=main.8e241f921459273be082.hot-update.js.map