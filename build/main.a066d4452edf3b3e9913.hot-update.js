  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function componentDidMount() {
      var _this$state4 = this.state,
          locationAndCategory = _this$state4.locationAndCategory,
          topicContent = _this$state4.topicContent,
          media = _this$state4.media,
          review = _this$state4.review;
      console.log(locationAndCategory.location, "address ");
      console.log(topicContent.title, "title");
      console.log(topicContent.description, "description");
      console.log(topicContent.amount, "amount");
    }
  }, {
    key: "render",
...
//# sourceMappingURL=main.a066d4452edf3b3e9913.hot-update.js.map