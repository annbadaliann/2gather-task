...
function (_React$Component) {
  ...
  function TopicSuggestion() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
        var _this$state4, locationAndCategory, topicContent, media, token, formData, res, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                formData.append("file", _this.state.imagesToUpload); // for (let i = 0; i < this.state.imagesToUpload.length; i++) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      console.log(this.state.lng, "lng");
...
//# sourceMappingURL=main.a0814622cc1d09f8bdfb.hot-update.js.map