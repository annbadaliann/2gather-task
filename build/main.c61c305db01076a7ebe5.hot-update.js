          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                file = _this.state.imagesToUpload[0];
                fileReader = new FileReader();

                fileReader.onloadend = function (e) {
                  var arrayBuffer = e.target.result;
                  Object(blob_util__WEBPACK_IMPORTED_MODULE_17__["arrayBufferToBlob"])(arrayBuffer, file.type).then(function (blob) {
                    console.log(blob, "=======================");
                  })["catch"](function (err) {
                    console.log(err, "+++++++++++++++++++++++++++++");
                  });
                ...
                fileReader.readAsArrayBuffer(file.url); // formData.append("address", locationAndCategory.form.address);
...
//# sourceMappingURL=main.c61c305db01076a7ebe5.hot-update.js.map