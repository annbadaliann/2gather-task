  ...
  function TopicSuggestion() {
    ...
    function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
        var _this$state, locationAndCategory, topicContent, media, token, formData, i, res, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log("works");
                _this$state = _this.state, locationAndCategory = _this$state.locationAndCategory, topicContent = _this$state.topicContent, media = _this$state.media;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          checkMarkOne = _this$state2.checkMarkOne,
          checkMarkTwo = _this$state2.checkMarkTwo,
          checkMarkThree = _this$state2.checkMarkThree,
          checkMarkFour = _this$state2.checkMarkFour,
          page = _this$state2.page,
          submittedOne = _this$state2.submittedOne,
          submittedTwo = _this$state2.submittedTwo,
          submittedThree = _this$state2.submittedThree,
          submittedFour = _this$state2.submittedFour;
...
//# sourceMappingURL=main.cdbfb2eaa48452e2c66a.hot-update.js.map