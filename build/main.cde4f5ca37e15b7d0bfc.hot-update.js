...
function (_React$Component) {
  ...
  function TopicSuggestion() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6___default()(_this), "handleSubmit", function (event, onLoggin, formErrors, validate) {
      event.preventDefault();
      var valid = true;
      Object.values(formErrors).forEach(function (val) {
        val.length > 0 && (valid = false);
      });
      Object.values(validate).forEach(function (val) {
        val === "" && (valid = false);
      });
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      var _this$state$locationA3 = this.state.locationAndCategory.form,
          ...
          categories = _this$state$locationA3.categories,
          categoryId = _this$state$locationA3.categoryId;
...
//# sourceMappingURL=main.cde4f5ca37e15b7d0bfc.hot-update.js.map