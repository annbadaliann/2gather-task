...
function (_React$Component) {
  ...
  function TopicSuggestion() {
      ...
      _this.setState(function (prevState) {
        return _objectSpread({}, prevState, {
          first: _objectSpread({}, prevState.first, {
            form: _objectSpread({}, prevState.first.form, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()({}, name, value))
          })
        });
      });
    });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "moveNextPage", function (page) {
      ...
      } else if (!first.form.category || !first.form.location) {
        _this.setState({
          inputWarning: true
        });
      } // if (page === 2) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(TopicSuggestion, [{
    ...
    value: function render() {
      ...
      var _this$state$first$for = this.state.first.form,
          location = _this$state$first$for.location,
          category = _this$state$first$for.category;
...
//# sourceMappingURL=main.e5135ca8cc67cb39fd78.hot-update.js.map